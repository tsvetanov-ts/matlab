...
lb = [0.2 0 0.5 0.01]; ub = [0.8 0.1 3 1]; x0 = [0.5 0.03 2 3];   % Monod

options = optimoptions('simulannealbnd','PlotFcns', {@saplotbestf,@saplotf});

options = optimoptions(options, 'InitialTemperature', 70, 'TemperatureFcn',@temperatureexp, 'ReannealInterval',77, 'DisplayInterval', 100);
